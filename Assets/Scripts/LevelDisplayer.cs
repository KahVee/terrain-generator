...
//Used to draw the terrain mesh and create it's texture
public class LevelDisplayer : MonoBehaviour {
    ...
    //Draws eight flat sea meshes around the central mesh
    //Useful for "Island Mode"
    ...
    //Creates a texture for the mesh pixel by pixel using the raw noise values.
    public Texture2D colorTexture(float[,] noise) {
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                ...
                //TODO: Replace with a gradient, colormap or something dependent on the normal and height of the vertex.
                if (colorValue < 0.1) {
